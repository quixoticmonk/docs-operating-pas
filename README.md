...
* [Content-to-book branch mapping](#content-to-book-branch-mapping)
* [Deployment Details](#deployment-details)
* [Notes on the config.yml](#config_yml)
* [Determine Content Repos and Branches of a Book](#determine-content-repos-and-branches-of-a-book)
* [Browser Support](#browser-support)

This project can create and publish the documentation for Pivotal Cloud Foundry (PCF) as a web application.
...
Here you'll find the configuration and templates for the Pivotal Cloud Foundry (PCF) documentation set published to [docs.pivotal.io](http://docs.pivotal.io).
...
We deploy this documentation as an app using Concourse pipelines, at https://p-concourse.wings.cf-app.com/teams/system-team-docs-docs-1-88aa/pipelines/cf-current
...
Once installed, configure Checkman to be aware of the CI builds by putting the following in a file called `~/Checkman/bookbinder`:
    ...
    PCF Bind: concourse.check https://pubtools.ci.cf-app.com REPLACE-WITH-USERNAME REPLACE-WITH-PASSWORD cf-current pcf-1-7

## Content-to-book branch mapping

The branches for this repo (`1.6`, `1.7`...) inform which of the PCF core docs versions this book publishes. Here are the product versions and which of the content repo branches they use to publish each version:

- PCF 1.6
  * Commercial content repos publish off of branch `1.6`
  * Open source content repos publish off of branch `225`
- PCF 1.7
  * Commercial content repos publish off of branch `1.7`
  * Open source content repos publish off of branch `235`
- PCF 1.8
  * Commercial content repos publish off of branch `1.8`
  * Open source content repos publish off of branch `239`
- PCF 1.9
  * Commercial content repos publish off of branch `master`
  * Open source content repos publish off of branch `master`
...
## <a name="config_yml"></a> Notes on the config.yml 
...
or on the branch corresponding to the current version number.
...
The styles used in PCF documentation are supported by recent versions of Chrome, Firefox, Edge, and Safari as well as IE10+. The styles used in PCF documentation are also mostly supported by recent versions of mobile Chrome and Safari.
